...
<table id="reserve-grid-moa" cellpadding="0" cellspacing="0" border="0" class="table table-striped" width="100%">
    <thead>
    <tr>
        <th>Ref lot</th>    
        <th>Description</th>
...
<script type="text/javascript" language="javascript" >
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#reserve-grid-moa').DataTable( {
            scrollY: "300px",
            "iDisplayLength": 5,
            "bLengthChange": false,
            paging: false,  
            ...
            "columnDefs": [
                ...
                { "width": "12%", "targets": 11,"visible": false },
            ],
            ...
            "serverSide": true,
            "ajax":{
                url :"reserve_grid_data_moa.php", // json datasource
