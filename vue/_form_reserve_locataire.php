...
<div class="row">
    <div class="col-lg-12">
        <?php if ($_SESSION['role']<>'6') { ?>
            <h4>Liste des réserves</h4>
            <?php } ?>
    </div>
</div>
<br>

<table id="reserve-grid-loc"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
    <thead>
    <tr>
        <th>Ref lot</th>    
        <th>Description</th>
...
?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="texte" class="form-control" id="description" name="description" placeholder="" value="" data-validation="letternumeric" data-validation-allowing=" -_">
                  </div>
                </div> 
...
<!--AFICHAGE DES RESERVES DE L'ENTREPRISE  -->
   ...
   <script type="text/javascript" language="javascript" >
       $(document).ready(function() {
        ...
        var dataTableEnt = $('#reserve-grid-loc').DataTable( {
            scrollY: "300px",
            "iDisplayLength": 5,
            "bLengthChange": false,
            paging: false,  
            ...
            "serverSide": true,
            "ajax":{
                url :"reserve_grid_data_loc.php", // json datasource
