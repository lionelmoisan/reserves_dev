...
<table id="reserve-grid-moe" cellpadding="0" cellspacing="0" border="0" class="table table-striped" width="100%">
    <thead>
    <tr>
        <th>Ref lot</th>    
        <th>Description</th>
...
<script type="text/javascript" language="javascript" >
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#reserve-grid-moe').DataTable( {
            scrollY: "300px",
            "iDisplayLength": 5,
            "bLengthChange": false,
            paging: false,  
            ...
            "columnDefs": [
                ...
                { "width": "14%", "targets": 8 ,"orderable":false},
            ...
            "serverSide": true,
            "ajax":{
                url :"reserve_grid_data_moe.php", // json datasource
        ...
        $("div.toolbar").html(' Trier par : <a href="#" id="allreserve" data-column="7" class="allreserve-input-button btn btn-default btn-lg  btn-sm" role="button">Afficher toutes les réserves</a>&nbsp;<a href="#" id="" data-column="7" class="nonleve-input-button btn btn-default btn-lg  btn-sm" role="button">Afficher les réserves non levées</a>');
