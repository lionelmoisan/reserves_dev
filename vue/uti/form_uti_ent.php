<?php require 'includes/header.php' ?>
    ...
    <div class="container">
        ...
        <form id="AddUtilisateur" action="up_utilisateur.php?id=<?php echo $_GET['id']?>" class="form-horizontal" method="post" data-toggle="validator">
            ...
            <!-- Input Entreprise *-->
            <div class="form-group aff-nomentreprise" id="entreprise">
                <label class="control-label col-sm-3" for="nom">Nom de l'entreprise *:</label>
                <div class="col-sm-4">
                    <input data-validation="required" type="texte" class="form-control" id="entreprise" name="entreprise" <?php  if ($_SESSION['role']==2) {echo $modif_champ;} ?>
            ...
            <div class="form-group" id="email">
                ...
                <div class="col-sm-5 txt-info"><span class='info-bleu'>info</span> : Si vous modifiez l'adresse e-mail, cet intervenant recevra un message lui demandant de confirmer que la nouvelle adresse est bien valide.</div>
