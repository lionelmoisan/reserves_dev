...
<div class="container">
    ...
    <form id="AddUtilisateur" action="up_utilisateur.php?id=<?php echo $_GET['id']?>" class="form-horizontal" method="post" data-toggle="validator">
        ...
        <div class="form-group aff-societe" id="societe">
            ...
            <div class="col-sm-4">
                <input type="texte" class="form-control" id="societe" name="societe"
        ...
        <div class="form-group aff-identifiant" id="identifiant">
            ...
            <div class="col-sm-4">
                <input data-validation="required" type="texte" class="form-control" id="identifiant" name="identifiant" <?php echo $modif_champ?>
